...
// Timing function for determining performance
...
void clContext::clInstance::manageClBuffers(vector< vector<T> > * inputs, vector< vector<T> > * outputs)
{
	...
	// Create the output buffer(s), these should all be initialised to 0 in host code for safety
