...
\alignauthor
Robert Clucas \\
\affaddr{School of Electrical \& Information Engineering}\\
\affaddr{University of the Witwatersrand}\\
\affaddr{Private Bag 3}\\
...
\begin{abstract}
	...
	when the kernel is executed. A \CPP Aspect-Oriented based Parallel Programming
	(CAPP) framework is developed, using Aspect\CPP and OpenCL, which defines aspects to 
	...
	\CPP code, essentially providing parallel programming in \CPP. The framework was 
	...
	implementation, and the resulting  CAPP framework \CPP code was simple and modular, 
	resembling the sequential \CPP implementation code. The amount of CAPP code required 
    for the examples was found to be comparable to that of \CPP AMP, another 
...
\begin{CCSXML}
	...
	languages</concept_desc>
	<concept_significance>300</concept_significanceAPP
...
% NOTE: Thisis how I generated the .bbl file
%
...
% NOTE : As per the above comment, I have copied the contents of the .bbl file here
...
\bibitem{gal:acppprop}
A.~Gal, W.~Schr{\"{o}}der-Preikschat, and O.~Spinczyk.
\newblock {A}spect{C}++: {L}anguage {P}roposal and {P}rototype
  {I}mplementation.
...
\bibitem{opencl}
Khronos Group.
\newblock {\em OpenCL 1.0 Specification}, Dec. 2008.
\newblock Rev. 29.
...
\bibitem{cuda}
Nvidia.
\newblock {\em {CUDA} {RUNTIME} {API}}, March. 2015.
\newblock \url{http://docs.nvidia.com/cuda/index.html#axzz3cGMEdjIx}.

\bibitem{gems:blackscholes}
M.~Pharr and C.~Kolb.
\newblock {\em Options Pricing on the GPU}.
\newblock Addison-Wesley Professional, 2005.

\bibitem{rapidmind}
RapidMind Inc.
\newblock {\em {W}riting {A}pplications for the {GPU} {U}sing the {R}apid{M}ind
  {D}evelopment {P}latform}, 2006.
\newblock
...
\newblock {OMI4}papps: {O}ptimisation, {M}odelling and {I}mplementation for
