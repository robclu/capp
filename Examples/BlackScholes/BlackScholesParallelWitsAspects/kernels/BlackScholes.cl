...
// Black Scholes formula for both calls and puts
...
__kernel void BlackScholes(
    ...
    __global float*	optNN,
	__global float* out
){
	const float R = 0.02f;			// Riskless rate of return
	const float V = 0.3f;			// Volatility
